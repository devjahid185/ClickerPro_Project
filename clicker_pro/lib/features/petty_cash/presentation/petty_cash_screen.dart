...
class PettyCashScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      backgroundColor: kIsWeb ? Colors.transparent : AppColors.surfaceAlt,
      appBar: AppBar(
...
/// Centres and caps its child's width on wide web so the petty-cash card + list
/// read as a column instead of stretching. Pass-through when [cap] is false.
