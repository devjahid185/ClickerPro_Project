...
class SettingsController extends Controller
{
    ...
    private static function getDefaultSettings(): array
    {
        return [
            ...
            'landing.hero_description' => 'Clicker Pro gives you the mobile app, web dashboard and admin console to run your photography company like a pro.',
            ...
            'landing.detail_admin_title' => 'Admin Console',
            'landing.detail_admin_text' => 'Control app details, landing content and launch URLs from the admin console with one secure dashboard.',
            'landing.detail_admin_cta' => 'Open Admin',
